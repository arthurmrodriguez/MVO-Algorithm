...
for dim=1:length(Problem_Dim)
  ...
  for f_index=1:length(FunctionNumbers)
    ...
    %10 times each function to get an average
    for times=1:tests
      %Execution of the algorithm
      [Best_score,Best_pos] = MVO(Universes_no,Max_iteration,lb,ub,Problem_Dim(dim),FunctionNumbers(f_index));
